      ...
      <div class="l-full">
        <ul class="o-page-tabs">
          <li class="o-page-tabs__item">
            <a class="o-page-tabs__link" href="/v1/raw/16-ft-account-dashboard.php">Dashboard</a>
          </li>
          <li class="o-page-tabs__item o-page-tabs__item--active">
            <a class="o-page-tabs__link" href="/v1/raw/17-account-mijn-boekingen.php">Mijn boekingen</a>
          </li>
          <li class="o-page-tabs__item">
            <a class="o-page-tabs__link" href="#">Mijn gegevens</a>
          </li>
          <li class="o-page-tabs__item">
            <a class="o-page-tabs__link" href="/v1/raw/13-account-inloggen.php">Uitloggen</a>
          </li>
        </ul>
      </div>
    </div>
        ...
        <div class="o-panel">
          ...
          <ul class="o-panel__list">
            <li class="o-panel__list__item">
              ...
              <p class="u-small-spacing is-small">Zorg ervoor dat alle taken afgerond zijn, eerder kan je de tickets niet downloaden.</p>
            </li>
              ...
              <form action="/" method="post">
                <fieldset>
                  <ul class="o-form u-no-spacing">
                    ...
                    <li class="o-form__item">
                      <div class="o-form__fields u-float-right">
