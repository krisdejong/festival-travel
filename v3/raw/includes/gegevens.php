<form action="/" method="post">
  <fieldset>
    <ul class="o-form">
      ...
      <li class="o-form__item o-form__item--half">
        <label class="o-form__label" for="">Nogmaals emailadres</label>
        <div class="o-form__fields">
      ...
      <li class="o-form__item o-form__item--half o-form__item--nolabel">
        <div class="o-form__fields">
          <div class="o-messages__item--success" />
            KNSM-laan, Amsterdam
            <a class="neutral-link neutral-link--underline js-add-field">Aanpassen</a>
          </div>
          <div class="o-form__fields o-form__fields--hidden">
            <input type="text" placeholder="Type hier het juiste adres" />
          </div>
        </div>
      </li>
      ...
      <li class="o-form__item o-form__item--half">
        <label class="o-form__label" for="">Herhaal wachtwoord</label>
        <div class="o-form__fields">
